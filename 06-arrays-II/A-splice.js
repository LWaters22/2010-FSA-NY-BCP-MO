...
/* 
its first argument is a starting index
the second argument is a count of elements to delete from the array, starting at the provided index 
*/
...
// let formerMembers = names.splice(2, 1, 'Ringo', 'Random');
